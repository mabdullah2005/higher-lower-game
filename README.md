...
Description:
    Created a Higher-Lower Card Game, showcasing my fundamental programming skills. developing this project in Python displays the transferability of my coding, as the combination of this project and the projects in my CV prove that I possess a strong understanding of Object-Oriented Programming. Each component of the Higher-Lower game is broken down into their seperate classes that have a singular responsibility, in line with OOP and SOLID principles. Test files for Card, Player and Deck classes were also developed to ensure each class functions as intended.
